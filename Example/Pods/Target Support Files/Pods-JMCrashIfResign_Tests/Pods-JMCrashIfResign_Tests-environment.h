...
// JMCrashIfResign
#define COCOAPODS_POD_AVAILABLE_JMCrashIfResign
#define COCOAPODS_VERSION_MAJOR_JMCrashIfResign 0
#define COCOAPODS_VERSION_MINOR_JMCrashIfResign 1
#define COCOAPODS_VERSION_PATCH_JMCrashIfResign 0
